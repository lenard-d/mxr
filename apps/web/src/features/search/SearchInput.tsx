...
export function SearchInput({ className }: { className?: string } = {}) {
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        "mail-search-trigger ml-auto h-10 min-w-0 flex-1 justify-start gap-3 border-primary/55 bg-primary/10 text-left text-xs font-normal text-foreground shadow-[0_0_0_1px_hsl(var(--primary)/0.1)] hover:border-primary/80 hover:bg-primary/15 sm:h-9 sm:w-[360px] sm:flex-none",
        className,
      )}
