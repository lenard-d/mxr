...
- account whose provider syncs stable message labels, with any message missing a `message_labels` association -> reset cursor and rebuild associations through full sync
